...
Interaction with the data base can be dont with GET, POST, PUT, and DELETE requests. For example, to get a specific burger with an index ID of 0, use the following code: 
....
...
NOTE : The `...` represents the remaining objects that have been omitted for berevity. 


==== `/burgers/id`

The burger/id endpoint will retrieve a specfic burger or object from the data base. 
